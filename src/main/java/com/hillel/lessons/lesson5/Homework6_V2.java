...
public class Homework6_V2 {
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= 5; i++) {
            while (true) {
                System.out.println("Please enter the number of frags for Player " + i);
                if (scannerTeam1.hasNextInt()) {
                    int playerScore = scannerTeam1.nextInt();
                    fragTeam1 += playerScore;
                    System.out.println("Player" + i + " = " + playerScore);
                    break;
                } else {
...
//        double arithmeticMeanTeam2 = fragTeam2 / 5;
        ...
        if (arithmeticMeanTeam1 < arithmeticMeanTeam2) {
            ...
            System.out.println("We have draw - Team " + team1 + ". Scored points - " + fragTeam1 + " and Team "
